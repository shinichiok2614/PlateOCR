...
class App:
    def __init__(self, root):
        ...
        # Video display
        self.video_label = tk.Label(left_frame, text="Video")
        ...
        right_frame = tk.Frame(root, width=380)
        right_frame.pack(side=tk.RIGHT, fill=tk.Y, padx=6, pady=6)

        tk.Label(right_frame, text="Danh sách phát hiện", font=("Arial", 12, "bold")).pack()
                ...
                for car_id, (px1, py1, px2, py2) in matches:
                    ...
                    try:
                        if plate_text:
                            ...
                            if not cur.fetchone():
                                cur.execute("INSERT INTO plate_logs (car_id,plate,car_path,plate_path,timestamp) VALUES (?,?,?,?,?)",
